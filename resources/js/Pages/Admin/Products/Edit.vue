<template>
  <AppLayout :company="company">
    <div class="bg-[#fffaf3] min-h-screen px-4 sm:px-6 md:px-8 py-6 md:py-8">
      ...
      <!-- Header -->
      <h1 class="text-2xl md:text-3xl font-bold text-[#f9a825] mb-6">Edit Product</h1>

      <!-- Form -->
      <form @submit.prevent="updateProduct" class="bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-md max-w-3xl mx-auto">
        <!-- Product Name -->
        <div class="mb-5">
