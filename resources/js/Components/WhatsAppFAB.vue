<template>
    <a
        ...
        class="fixed bottom-8 right-8 z-50 flex items-center justify-center group"
    >
        <span
...
<script setup>
import { ref, onMounted } from "vue"; // <-- Import ref & onMounted
...
defineProps({
    ...
    phone: {
        type: String,
        default: "+6289649079690",
    },
    /** Pesan default yang langsung muncul di chat */
    message: {
        type: String,
        default: "Halo, Aku mau nanya perihal produk yang ada di website",
    },
});

// --- Tambahkan Blok Ini (Animasi Pop-in) ---
...
onMounted(() => {
    ...
    // Animasikan "pop-in" setelah 1 detik
    gsap.to(fabRef.value, {
        scale: 1,
        opacity: 1,
        duration: 0.5,
        ease: "back.out(1.7)", // Efek 'mental' yang bagus
