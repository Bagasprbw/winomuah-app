    ...
    <AppLayout>
        ...
        >
            <div class="absolute inset-0 bg-black/10">
                <img
                    src="/public/assets/BG-Hero4.jpg"
                    alt="Handcrafted keychains background"
                    class="w-full h-full object-cover mix-blend-overlay opacity-100"
                />
            </div>
            ...
            <div class="relative z-10 text-center px-6 py-20 max-w-5xl mx-auto">
                <h1
                    class="text-4xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg leading-tight"
                >
                    Discover the Art of Winomuah
                </h1>
                <p
                    class="text-white text-lg md:text-xl mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow"
                >
        ...
        <section ref="productsRef" id="products" class="py-20 px-4 md:px-8">
            <div class="max-w-7xl mx-auto">
                <h2
                    class="text-4xl md:text-5xl font-bold text-center text-gray-800 mb-12"
                >
                    Featured Products
                </h2>
        ...
        >
            <div class="max-w-7xl mx-auto">
                ...
                <div
                    v-if="props.portofolios.length"
                    class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"
                >
                    <PortofolioCard
                        v-for="portofolio in props.portofolios"
                        :key="portofolio.id"
                        :portofolio="{
                ...
                <div class="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="space-y-6">
                        ...
                        <p class="text-gray-600 text-lg leading-relaxed">
                            Turn your ideas into reality with our custom
                            keychain design service. Our team of skilled
                            designers will work with you to create a unique
                            keychain that perfectly reflects your style and
                            personality.
                        </p>
                        <button
        ...
        >
            <div class="max-w-3xl mx-auto text-center space-y-8">
                ...
                <p class="text-gray-600 text-lg md:text-xl">
                    For inquiries or custom orders, please reach out to us via
                    WhatsApp.
                </p>
                <a
        ...
        <CustomModal :isOpen="showCustomModal" @close="closeCustomModal" />
    </AppLayout>
</template>
